...
const replaceZeros = (string) => {
  ...
  let patt1 = /0/g ;
  let result = string.replace(patt1,"zero");
  return result
}
...
const addQuestion = (arr) => {
  ...
  let result=arr.map(function (item,ind){
  return item+"?"
...
const mapTwoToThe = (arr) => {
  // Solution code here...
  let result=arr.map(function (it,ind){
