...
function transformToLis(obj){
 ...
 Object.entries(obj).forEach(ele => {
  ...
  let str=ele.toString().replace(",",": ")
    let string1=`<li>${str}</li>`
xARR.push(string1)
...
const addValues = (arr) => {
  // Solution code here...
  let result = arr.reduce( function(sumation,value) {
...
const addPurchases = (arr) => {
  // Solution code here...
  let result = arr.reduce( function(sumation,value) {
// console.log(sumation,value)
  sumation += value.purchasePrice;
  return sumation;
},0);
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  // let res=arr.reduce(function(sum,value,ind){
...
const reversedString = (str) => {
  // Solution code here...
  let x= str.split(str.charAt(str.length+1))// console.log(x)

// console.log(x)
   let res = x.reduce((sum, char) => {
// console.log(sum)
sum = char + sum
        return sum
    },)
